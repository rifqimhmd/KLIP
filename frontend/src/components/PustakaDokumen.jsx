    ...
    <section id="pustakadokumen" className="py-12">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
          Kumpulan dokumen pendukung ini disiapkan dan digunakan sebagai
          referensi utama dalam kegiatan konsultasi dan pelaporan di Klinik
          Patnal, untuk memastikan setiap proses kepatuhan, keputusan internal,
          dan prosedur operasional didasarkan pada informasi yang akurat, jelas,
